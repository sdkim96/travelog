        ...
        if kw:
            ...
            question_list = question_list \
                ...
                .filter(Question.subject.ilike(search) |  # 질문제목
                        ...
                        Question.local.ilike(search) #지역
                        ) \
                .distinct()
...
def create():
    ...
    if request.method == 'POST' and form.validate_on_submit():
        question = Question(subject=form.subject.data, content=form.content.data, local=form.local.data, create_date=datetime.now(), user=g.user)
